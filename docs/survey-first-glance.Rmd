...
datafile <- "../data/raw/Data_Privacy_Survey_20220405.csv" # This file has multiple responses in separate columns (so very wide format but tidier)
...
- Separate responses if people gave multiple responses so they are counted separately -> Have not yet found a solution for  this.
   - Perhaps str_split is a good workaround. str_split(dppsurvey$Faculty,",",simplify = T, n=2) -> Returns a matrix column with a list of separate responses that can then be visualized irrespective of whether a person responded gave multiple responses. Made sure in the data recode in Qualtrics that the text in the data does not contain any commas so str_split should then work. Data needs to be downloaded anew!
