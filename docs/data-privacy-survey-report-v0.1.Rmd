...
datafile <- "../data/raw/Data_Privacy_Survey_20220522.csv"
...
From the survey respondents, `r length(dppsurvey$Email_1_TEXT[!is.na(dppsurvey$Email_1_TEXT)])` researchers left their email address to be contacted. Of those, 20 replied to our email asking to meet up. So far, 12 one-on-one, mostly online, meetings of have been conducted, each taking about 30 minutes. During the meetings, at least one of the project coordinators was present, together with either the other project coordinator or the relevant faculty privacy officer. 
