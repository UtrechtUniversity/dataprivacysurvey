...
```{r knowpoplot, warning = FALSE, message = FALSE}
...
## Challenges and needs (open text responses and one-on-one meetings)
...
Please note that there is overlap between the open questions in the survey and
the meeting notes, and therefore some codes may have been applied twice for the 
same researcher. 
...
Below we go into the most frequently mentioned challenge/need expressed:
...
Some respondents indicate not to know where to go for help with privacy-related
matters. One researcher indicates to prefer having 1 place to go to for all
...
times) indicated that support staff could sometimes provide support 
in a more hands-on fashion, rather than abstract advice and telling researchers 
how *not* to do things. Some researchers add that privacy professionals have a 
tendency to cling to the letter of the law, instead of looking at how to apply 
...
### Less bureaucracy
Processes are often experienced as being time-inefficient, and sometimes longer 
and more bureaucratic than necessary. Some researchers argue that (part of) this 
burden should be relieved or carried by support staff:
