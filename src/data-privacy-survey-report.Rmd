...
abstract: |
  ...
  services concerning personal data in research. The results show that most 
  ...
  [Recommendations report](data-privacy-survey-recommendations). The current 
...
refer to the [Recommendations report](data-privacy-survey-recommendations).
...
researchers from the Faculty of Geosciences left their email address to be contacted. 
Of those, `r dim(interviews_geo)[1]` online meetings have been conducted. Below, 
the division over positions can be seen for the interviewees from the Geosciences 
faculty.
...
manually coded to enable the extraction of action points (see the file <a href="https://github.com/UtrechtUniversity/dataprivacysurvey/blob/main/documentation/codes-open-text-responses-meetings.csv" 
target="_blank">codes-open-text-responses-meetings.csv</a> for the codes used).
...
- A <a href = "https://utrechtuniversity.github.io/dataprivacysurvey" target = "_blank">general 
description</a> and links to the relevant written reports.
- The 
...
- <a href = "https://github.com/UtrechtUniversity/dataprivacysurvey/blob/main/documentation/survey-codebook.csv" target = "_blank">Codebook</a> of the survey in .csv format.

### Code {#code-availability}
The repository contains all <a href="https://github.com/UtrechtUniversity/dataprivacysurvey/tree/main/src" target = "_blank">
scripts and documents</a> used to clean the data and write the reports.
...
<a href="https://github.com/UtrechtUniversity/dataprivacysurvey/tree/main/data/processed/Data_Privacy_Survey_fakedataset_20220929.csv" target = "_blank">synthetic (fake) dataset</a> with 100 rows using 
...
1. Clone <a href="https://github.com/UtrechtUniversity/dataprivacysurvey" target="_blank">the repository</a> from GitHub.
2. Open <a href="https://github.com/UtrechtUniversity/dataprivacysurvey/blob/main/src/pseudonymise-data.R" 
target="_blank">pseudonymise-data.R</a>, change the path to the ("raw") dataset 
...
3. Open the file <a href="https://github.com/UtrechtUniversity/dataprivacysurvey/blob/main/src/data-privacy-report.Rmd" 
target="_blank">data-privacy-survey-report.Rmd</a> and knit the document. Note that
...
researcher performed in the faculty. In terms of *personal* data, the same 
...
This report was last generated on: `r as.character(Sys.Date())`. It was 
