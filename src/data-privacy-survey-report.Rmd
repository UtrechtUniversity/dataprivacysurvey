...
plotdepartments(dppsurvey_science, "Science", 
                 title = "Departmental representation Science faculty", 
                 caption = "Survey respondents per department in the Science faculty in percentage")
```
### FSBS
...
plotdepartments(dppsurvey_fsw, "FSW", 
                 title = "Departmental representation FSBS", 
                 caption = "Survey respondents per department at FSBS in percentage")
```
...
plotdepartments(dppsurvey_hum, "Humanities", 
                 title = "Departmental representation Faculty of Humanities", 
                 caption = "Survey respondents per department at the Faculty of Humanities in percentage")
```
...
plotdepartments(dppsurvey_vet, "DGK", 
                 title = "Departmental representation Veterinary Medicine", 
                 caption = "Survey respondents per department at the Faculty of Veterinary Medicine in percentage")
```
### LEG
...
plotdepartments(dppsurvey_leg, "REBO", 
                 title = "Departmental representation LEG", 
                 caption = "Survey respondents per department at the Faculty of Law, Economics, and Governance in percentage")
```
...
plotdepartments(dppsurvey_geo, "Geo", 
                 title = "Departmental representation Geosciences", 
                 caption = "Survey respondents per department at the Faculty of Geosciences in percentage")
```
...
datatypegraphs <- dppsurvey %>% 
  ...
  labs(x = "", 
       ...
       caption = "Types of personal data used in every UU faculty") +
  coord_flip() +
  theme_classic() +
  geom_col(fill = uucol) +
...
For the Faculty of Science, no respondents indicated to publish datasets,
...
which format they publish their data, if they do (left), or which reasons 
researchers indicated to have to not publish data.

```{r publicationformat-fsw}
...
Below you can see for the Faculty of Humanities in which format they publish their 
data, if they do (left), or which reasons researchers indicated to have to not 
publish data.

```{r publicationformat-hum}
...
For the Faculty of Veterinary Medicine, no respondents indicated to publish datasets,
only metadata if applicable. Therefore, there were no respondents who filled out
the question about the data format in which the data were published.

```{r publicationformat-dgk}
...
Below you can see for the Faculty of Law, Economics and Governance in which 
format they publish their data, if they do (left), or which reasons researchers 
indicated to have to not publish data.

```{r publicationformat-leg}
...
For the Faculty of Geosciences, no respondents indicated to publish datasets,
only metadata if applicable. Therefore, there were no respondents who filled out
the question about the data format in which the data were published.

```{r publicationformat-geo}
...
most personal data seems to be processed, a small majority of respondents is not 
...
there are some differences between faculties (see the different tabs).
...
As shown below, all sources mentioned were to some extent
