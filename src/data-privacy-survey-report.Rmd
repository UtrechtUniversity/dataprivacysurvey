...
datatypegraphs <- dppsurvey %>% 
  ...
  mutate(Percentage = round(Count/dim(dppsurvey)[1]*100,0)) %>%
...
measuresplot(dppsurvey_science)
```
...
#### Science
Below the usage and content of informed consent forms at the Science faculty is
displayed.
...
#### Veterinary Medicine
Below the data sharing practices across the Faculty of Veterinary Sciences are 
visualised.
